...
CREATE PROCEDURE comprar_entrada(IN nif VARCHAR(9),IN cuenta INT UNSIGNED, IN id_cuenta INT UNSIGNED, IN id_butaca INT UNSIGNED,OUT error TINYINT UNSIGNED)
BEGIN
