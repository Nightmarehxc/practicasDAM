...
CREATE INDEX HOSPITAL_NOM 
ON sanitat.HOSPITAL (NOM) ;

INSERT INTO sanitat.HOSPITAL 
VALUES
  (
    13,
    'Provincial',
...
CREATE INDEX SALA_HOSP_NOM 
ON sanitat.SALA (HOSPITAL_COD, NOM) ;

INSERT INTO sanitat.SALA 
VALUES
...
CREATE TABLE IF NOT EXISTS sanitat.PLANTILLA (
  ...
  SALARI INT (10),
  CONSTRAINT PLANTILLA_PK PRIMARY KEY (
    HOSPITAL_COD,
    SALA_COD,
    EMPLEAT_NO
  ),
...
CREATE INDEX PLANTILLA_HOSP_COGNOM 
ON sanitat.PLANTILLA (HOSPITAL_COD, COGNOM) ;

CREATE INDEX PLANTILLA_HOSP_FUNCIO 
ON sanitat.PLANTILLA (HOSPITAL_COD, FUNCIO) ;

CREATE INDEX PLANTILLA_FUNCIO_HOSP_SALA 
ON sanitat.PLANTILLA (FUNCIO, HOSPITAL_COD, SALA_COD) ;

INSERT INTO sanitat.PLANTILLA 
VALUES
  (
    13,
    6,
...
CREATE TABLE IF NOT EXISTS sanitat.MALALT (
  ...
  ADRECA VARCHAR (20),
  DATA_NAIX DATE,
  SEXE CHAR (1) NOT NULL CHECK (SEXE = 'H' 
    OR SEXE = 'D'),
  NSS CHAR(9)
) ;

CREATE INDEX MALALT_NAIX_COGNOM 
ON sanitat.MALALT (DATA_NAIX, COGNOM) ;

CREATE INDEX MALALT_COGNOM_NAIX 
ON sanitat.MALALT (COGNOM, DATA_NAIX) ;

INSERT INTO sanitat.MALALT 
VALUES
  (
    10995,
    'LaguM.',
...
CREATE INDEX INGRESSOS_HOSP_SALA 
ON sanitat.INGRESSOS (HOSPITAL_COD, SALA_COD) ;

INSERT INTO sanitat.INGRESSOS 
VALUES
  (10995, 13, 3, 1) ;
...
INSERT INTO sanitat.DOCTOR 
VALUES
  (13, 435,'L󰥺 A.','Cardiologia') ;
...
CREATE INDEX DOCTOR_ESP_HOSP 
ON sanitat.DOCTOR (ESPECIALITAT, HOSPITAL_COD) ;

CREATE INDEX DOCTOR_HOSP_ESP 
ON sanitat.DOCTOR (HOSPITAL_COD, ESPECIALITAT) ;
